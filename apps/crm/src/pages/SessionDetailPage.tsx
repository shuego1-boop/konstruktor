        ...
        {data && (
          <>
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 flex flex-wrap gap-8">
              <div>
                <p className="text-3xl font-bold text-slate-800">{data.score}%</p>
            ...
            <div className="space-y-3">
              <h2 className="text-base font-semibold text-slate-700">Ответы по вопросам</h2>
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <p className="text-xs text-slate-400">{a.pointsEarned} очк.</p>
                      <p className="text-xs text-slate-400">{formatMs(a.responseTimeMs)}</p>
                    </div>
                  </div>
                </div>
              ))}
